...
import * as _featureFields from './featureFields.mjs';
import * as _featureFormats from './featureFormats.mjs';
...
export default {
  decorate,
  fade,
  featureFields: { ..._featureFields },
  featureFormats: { ..._featureFormats },
  featureHover,
  featureStyle,
  formats,
