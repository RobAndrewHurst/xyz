...
import * as _gazetteer from './gazetteer.mjs';
...
import * as _userIndexedDB from './userIndexedDB.mjs';
import * as _userLocale from './userLocale.mjs';
