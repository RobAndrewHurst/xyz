...
export function paramString() {
  describe('paramString:', () => {
     ...
     * @function it
     */
    it('Should return empty param string', () => {
      const params = null;
     ...
     * @function it
     */
    it('Should return urlencoded string', () => {
      const params = {
        id: 1,
        name: 'test',
        age: '29 ',
     ...
     * @function it
     */
    it('Should return urlencoded string, excluding null and undefined values', () => {
      const params = {
        id: null,
        name: undefined,
        age: '29 ',
     ...
     * @function it
     */
    it('Should correctly encode ampersands and spaces', () => {
      const params = {
        region: 'Test & More',
